...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { city: @adress.city, flat: @adress.flat, house: @adress.house, street: @adress.street, user_id: @adress.user_id } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { city: @adress.city, flat: @adress.flat, house: @adress.house, street: @adress.street, user_id: @adress.user_id } }
