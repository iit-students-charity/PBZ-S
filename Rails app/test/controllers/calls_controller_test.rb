...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post calls_url, params: { call: { city: @call.city, duration: @call.duration, invoice_id: @call.invoice_id, payment_state: @call.payment_state, time: @call.time, user_id: @call.user_id } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { city: @call.city, duration: @call.duration, invoice_id: @call.invoice_id, payment_state: @call.payment_state, time: @call.time, user_id: @call.user_id } }
